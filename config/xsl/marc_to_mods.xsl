...
-->
        ...
        <originInfo>
           ...
           <!-- CUL excluding the placeTerms from 008 contorlField -->
           <!--
...
-->
        ...
        <!-- CUL pulls in catalog identifiers from 001 -->
        <xsl:for-each select="marc:controlfield[@tag='001']">
            <identifier type="local">clio.<xsl:value-of select="."/></identifier>
            <identifier type="CLIO">CLIO_<xsl:value-of select="."/></identifier>
        </xsl:for-each>
        ...
        <!-- CUL inserts a relatedItem for Projects into the stub records -->
        <relatedItem type="host" displayLabel="Project">
            <titleInfo>
                <title>Miscellaneous Content</title>
            </titleInfo>
        </relatedItem>
        <!--  CUL: location  992 -->
        <xsl:for-each select="marc:datafield[@tag=992]">
            <xsl:call-template name="createLocationFrom992"/>
        </xsl:for-each>
        ...
        <recordInfo>
            ...
            <recordOrigin>Converted from MARCXML to MODS version 3.5 using MARC21slim2MODS3-5.xsl
                (Revision 1.102 2014/08/12) with additional editing by Columbia University Libraries</recordOrigin>
...
<!-- tmee 1.93 20140130 -->
    ...
    <!-- CUL location -->
    <xsl:template name="createLocationFrom992">
        <xsl:for-each select="./marc:subfield[@code='a']">
            <location>
                <physicalLocation><xsl:value-of select="." /></physicalLocation>
                <xsl:choose>
                    <xsl:when test=". = 'East Asian'">
                        <physicalLocation authority='marcorg'>NNC-EA</physicalLocation>
                    </xsl:when>
                    <xsl:when test=". = 'Rare Book'">
                ...
                <xsl:for-each select="//marc:datafield[@tag=991]/marc:subfield[@code='a']">
